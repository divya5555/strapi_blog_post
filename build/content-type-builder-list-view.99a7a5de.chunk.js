"use strict";(self.webpackChunkblog_project=self.webpackChunkblog_project||[]).push([[5905],{3500:(oe,O,n)=>{n.r(O),n.d(O,{default:()=>rt});var e=n(67294),v=n(90731),u=n(96987),B=n(12473),H=n(34726),g=n(16607),l=n(30972),M=n(83598),w=n(18226),D=n(2382),X=n(97695),V=n(27361),r=n.n(V),f=n(18721),T=n.n(f),b=n(18446),x=n.n(b),k=n(11700),z=n.n(k),P=n(86896),J=n(16550),G=n(5923),ge=n(3547),fe=n(29299),_=n(69398),Z=n(10574),je=n(38454),Be=n(45697),o=n.n(Be),K=n(27523),he=n(47558),C=n(90635),$=n(71997);const ye=$.default.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`,Ne=(0,$.default)(g.x)`
  ...
  position: relative;
  left: -0.25rem;
`,ve=({children:t,icon:a,color:s,...i})=>e.createElement(Ne,{paddingBottom:4,paddingTop:4,as:"button",type:"button",...i},e.createElement(u.k,null,e.createElement(ze,{color:s,"aria-hidden":!0,background:`${s}200`},a),e.createElement(g.x,{paddingLeft:3},e.createElement(Z.Z,{variant:"pi",fontWeight:"bold",textColor:`${s}600`},t))));ve.propTypes={color:o().string.isRequired,children:o().string.isRequired,icon:o().node.isRequired};const Qe=ve,Ve=(0,$.default)(g.x)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,M=(0,v.default)(u.x)`
  ...
  width: 100%;
  border: none;
`,w=({children:D,icon:X,...V})=>(0,e.jsxs)("div",{children:[(0,e.jsx)(B.i,{}),(0,e.jsx)(M,{as:"button",background:"primary100",padding:5,...V,children:(0,e.jsxs)(H.k,{children:[(0,e.jsx)(l,{"aria-hidden":!0,background:"primary200",children:X}),(0,e.jsx)(u.x,{paddingLeft:3,children:(0,e.jsx)(g.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:D})})]})})]})}}]);
